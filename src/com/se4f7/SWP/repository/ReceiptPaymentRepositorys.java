...
public class ReceiptPaymentRepositorys {
	...
	private static final String SELECT_STATUS = "select * from work where status = ? and IsDelete = '0'";
	...
	private static final String SELECT_RECEIPT = "SELECT COUNT(*) AS total_receipt from work where status = 0 and isDelete ='0'";
	private static final String SELECT_PAYMENT = "SELECT COUNT(*) AS total_payment from work where status = 1 and isDelete ='0'";
